...
league_name = "Fußball Knowledge gefragt"  # Name of your league, must be exact match, can be done via env or hardcoded
start_budget = 50_000_000               # Starting budget of your league, used to calculate current budgets of other managers
league_start_date = "2025-11-02"        # Start date of your league, used to filter activities, format: YYYY-MM-DD
